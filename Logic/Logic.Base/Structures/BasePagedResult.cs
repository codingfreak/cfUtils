namespace codingfreaks.cfUtils.Logic.Base.Structures
{
        ...
        where TEntity : class, IEntity
    {
        ...
        /// A tranform method to convert <typeparamref name="TEntity" /> to <typeparamref name="TResult" />
        /// .
        /// </param>
        /// <returns>The converted result.</returns>
        public BasePagedResult<TResult> Convert<TResult>(Func<TEntity, TResult> transform)
