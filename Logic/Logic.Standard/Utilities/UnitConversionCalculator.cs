namespace codingfreaks.cfUtils.Logic.Standard.Utilities
{
    using System;
    ...
    public static class UnitConversionCalculator
    {
        ...
        /// </summary>
        public const double AccelerationToG = 0.101972;
        ...
        /// </summary>
        /// <param name="centiMeters">The height in cm.</param>
        /// <returns>The height in in.</returns>
        public static double ConvertCentimetersToInches(int centiMeters)
        {
