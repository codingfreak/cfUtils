...
namespace codingfreaks.cfUtils.Logic.Core.Utilities
{
    ...
    public static class TraceUtil
    {
        ...
        /// <summary>
        /// Writes a trace error line including caller information if TRACE conditional compiler attribute is set.
        /// </summary>
        /// <param name="message">The message to write.</param>
        /// <param name="callerName">The class name of the caller (passed in automatically).</param>
        /// <param name="callerFilePath">The file name of the caller (passed in automatically).</param>
        /// <param name="callerLineNumber">The line number inside the caller (passed in automatically).</param>
        ...
        /// <summary>
        /// Writes a trace info line including caller information if TRACE conditional compiler attribute is set.
        /// </summary>
        /// <param name="message">The message to write.</param>
        /// <param name="callerName">The class name of the caller (passed in automatically).</param>
        /// <param name="callerFilePath">The file name of the caller (passed in automatically).</param>
        ...
        /// <summary>
        /// Writes a trace warning line including caller information if TRACE conditional compiler attribute is set.
        /// </summary>
        /// <param name="message">The message to write.</param>
        /// <param name="callerName">The class name of the caller (passed in automatically).</param>
        /// <param name="callerFilePath">The file name of the caller (passed in automatically).</param>
