namespace codingfreaks.cfUtils.Logic.Core.Extensions
{
    ...
    /// <summary>
    /// Adds extension methods to <see cref="decimal" />.
    /// </summary>
    public static class DecimalExtensions
    {
        ...
        public static string ToCurrencyString(this decimal? number, IFormatProvider formatProvider)
        {
            return number.HasValue ? number.Value.ToCurrencyString(formatProvider) : string.Empty;
        }
