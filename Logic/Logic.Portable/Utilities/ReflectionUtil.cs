namespace codingfreaks.cfUtils.Logic.Portable.Utilities
{
    ...
    public static class ReflectionUtil
    {
        ...
        /// </summary>
        /// <param name="assemblyInfo">The assembly-informations.</param>
        ...
        public static string GetAssemblyCompany(Assembly assemblyInfo)
        {
            ...
            var converted = attr.First() as AssemblyCompanyAttribute;
            if (converted != null)
            {
        ...
        public static string GetAssemblyCopyright(Assembly assemblyInfo)
        {
            ...
            var converted = attr.First() as AssemblyCopyrightAttribute;
            if (converted != null)
            {
        ...
        public static string GetAssemblyDescription(Assembly assemblyInfo)
        {
            ...
            var converted = attr.First() as AssemblyDescriptionAttribute;
            if (converted != null)
            {
        ...
        public static string GetAssemblyProduct(Assembly assemblyInfo)
        {
            ...
            var converted = attr.First() as AssemblyProductAttribute;
            if (converted != null)
            {
        ...
        public static string GetAssemblyTitle(Assembly assemblyInfo)
        {
            ...
            var converted = attr.First() as AssemblyTitleAttribute;
            if (converted != null)
            {
        ...
        /// <summary>
        /// Retrieves all assembly version informations.
        /// </summary>
        /// <param name="assemblyInfo">The assembly-informations.</param>
        /// <returns>The version of the assembly.</returns>
        ...
        /// <param name="mustBeWriteable">Indicates whether the property must be writeable.</param>
        /// <returns><c>true</c> if the property exists, otherwise <c>false</c>.</returns>
        public static bool HasProperty(this Type type, string propertyName, bool mustBeWriteable = false)
        {
            ...
            return !mustBeWriteable || prop.CanWrite;
        }
        ...
        /// <param name="mustBeWriteable">Indicates whether the property must be writeable.</param>
        /// <returns><c>true</c> if the property exists, otherwise <c>false</c>.</returns>
        public static bool HasProperty(this Type type, string propertyName, Type returnType, bool mustBeWriteable = false)
        {
        ...
        public static void SetProperty<TPropertyType>(this Type type, object instance, string propertyName, TPropertyType value)
        {
            ...
            {
                throw new InvalidOperationException("Could not find property on type or property isn't writeable.");
            }
