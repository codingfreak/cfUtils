namespace codingfreaks.cfUtils.Logic.Portable.Extensions
{
    ...
    public static class DateTimeExtensions
    {
        ...
        public static DateSpanInfo GetCalendarHalfYearInfo(this DateTime current)
        {
        ...
        public static DateSpanInfo GetCalendarMonthInfo(this DateTime current)
        {
        ...
        public static IEnumerable<DateSpanInfo> GetCalendarMonthsForYear(this int year)
        {
            var result = new List<DateSpanInfo>();
            var currentMonth = 0;
            // 1. Get first and last day
        ...
        public static DateSpanInfo GetCalendarQuarterInfo(this DateTime current)
        {
        ...
        public static IEnumerable<DateSpanInfo> GetCalendarQuartersForYear(this int year)
        {
            var result = new List<DateSpanInfo>();
        ...
        public static DateSpanInfo GetCalendarWeekInfo(this DateTime current)
        {
        ...
        public static IEnumerable<DateSpanInfo> GetCalendarWeeksForYear(this int year, CultureInfo culture = null)
        {
            if (culture == null)
            {
                culture = CultureInfo.CurrentUICulture;
        ...
        /// <summary>
        /// Retrieves the very first day of a year depending of the <see cref="CalendarWeekRule"/> of the given <paramref name="culture"/>.
        /// </summary>
        /// <param name="year">The year to examine.</param>
        /// <param name="culture">The culture to use or <c>null</c> if <see cref="CultureInfo.CurrentUICulture"/> should be taken.</param>
        ...
        /// <summary>
        /// Returns a string which contains the relative date span from the dtmBase-view. It returns words like 'tomorrow', 'yesterday' ...
        /// </summary>
        /// <remarks> 
        /// <list type="bullet">
        /// <listheader>
        ...
        /// </listheader>
        /// <item><term>RelativeDateSpanToday</term><description>Today</description></item>
        /// <item><term>RelativeDateSpanYesterday</term><description>Yesterday</description></item>
        /// <item><term>RelativeDateSpanTomorrow</term><description>Tomorrow</description></item>
        /// <item><term>RelativeDateSpanBeforeYesterday</term><description>before 2 days</description></item>
        /// <item><term>RelativeDateSpanAfterTomorrow</term><description>in 2 days</description></item>
        /// <item><term>RelativeDateSpanDaysBefore</term><description>before {0} days</description></item>
        /// <item><term>RelativeDateSpanDaysAfter</term><description>in {0} days</description></item>
        /// </list>
        /// </remarks>
        ...
        /// <summary>
        /// Calculates the years which are gone between the <paramref name="dateInFuture"/> and the given <paramref name="dateInPast"/>.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="dateInPast">The date which is the older part. Will be used as <see cref="DateTime.Now"/> if <c>null</c> is given.</param>
        ...
        /// <summary>
        /// Calculates the years which are gone between the <paramref name="dateInPast"/> and the given <paramref name="dateInFuture"/>.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="dateInFuture">The date which is the older part. Will be used as <see cref="DateTime.Now"/> if <c>null</c> is given.</param>        
        ...
        {
            return date.HasValue ? date.Value.ToString("D") : string.Empty;
        }
        ...
        /// <summary>
        /// Retrieves the string representation for a given nullable <paramref name="date"/> depending on a given <paramref name="format"/>.
        /// </summary>
        /// <param name="date">The date or <c>null</c>.</param>
