namespace codingfreaks.cfUtils.Logic.Portable.Extensions
{
    ...
    public static class EnumerableExtensions
    {
        ...
        /// <summary>
        /// Iterates through a list of T and retrieves the index of the <paramref name="element"/> inside the enumarable.
        /// </summary>
        ...
        public static int GetIndexOf<T>(this IEnumerable<T> enumerable, T element) where T : IComparable
        {
        ...
        /// <summary>
        /// Iterates through a list of T and retrieves the index of the element matching the <paramref name="compareFunc"/> inside the enumarable.
        /// </summary>
        /// <typeparam name="T">The type of an element inside the <paramref name="enumerable"/>.</typeparam>
        /// <param name="enumerable">The enumerable to extend.</param>
